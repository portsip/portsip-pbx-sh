...
set_firewall(){
    ...
    firewall-cmd -q --permanent --delete-service=portsip-sbc || true
    firewall-cmd --reload
    firewall-cmd --permanent --add-service=ssh
    firewall-cmd --permanent --new-service=portsip-sbc || true
    firewall-cmd --permanent --service=portsip-sbc --add-port=25000-35000/udp --add-port=5066/udp --add-port=5065/tcp --add-port=5067/tcp --add-port=5069/tcp --add-port=8882/tcp --add-port=8883/tcp --add-port=10443/tcp --set-description="PortSIP SBC"
