...
EOF
    ...
    set +e
    docker compose -f docker-compose-portsip-pbx-init.yml down -v > /dev/null || true
    docker compose -f docker-compose-portsip-pbx-init.yml up -d --wait > /dev/null
    local crtOrUpRetEnv=$?
    ...
    docker compose -f docker-compose-portsip-pbx.yml up -d > /dev/null
