...
heplify_img="registry.cn-hangzhou.aliyuncs.com/portsip/trace-server:heplify-16"
webapp_img="registry.cn-hangzhou.aliyuncs.com/portsip/trace-server:webapp-16"
db_img="registry.cn-hangzhou.aliyuncs.com/portsip/trace-server:postgres11-alpine"
