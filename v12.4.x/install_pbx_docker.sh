...
Install_docker_on_centos(){
 ...
 firewall-cmd --permanent --new-service=portsip-pbx
  firewall-cmd --permanent --service=portsip-pbx --add-port=5060/udp --add-port=5065/tcp --add-port=45000-64999/udp --add-port=25000-34999/udp --add-port=5065/tcp --add-port=8899-8900/tcp --add-port=8887-8888/tcp --add-port=8881-8884/tcp --set-description="PortSIP PBX"
